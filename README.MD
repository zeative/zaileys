...
> **Quick Jump:** [Create](#create-group) · [Participants](#manage-participants) · [Profile](#group-profile) · [Settings](#group-settings) · [Invite Code](#invite-code) · [Leave](#leave-group)
...
// Update group icon (from URL or Buffer)
