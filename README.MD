...
> ✅ Carousel is the only button type that is **fully supported on all devices** — Android, iOS, and **WhatsApp Desktop/Web**. Each card can include an image or video header with native flow buttons.
