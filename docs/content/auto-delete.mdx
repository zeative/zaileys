---
description: "Automatically prune old messages from the local zaileys store — configure a rolling retention window, per-chat count caps, and custom chat filters without touching WhatsApp servers."
---
