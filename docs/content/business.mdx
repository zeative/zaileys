---
description: "Access WhatsApp Business features with zaileys — read business profiles, browse product catalogs and collections, fetch order details, and create, update, or delete catalog products. Requires a WhatsApp Business account."
---
