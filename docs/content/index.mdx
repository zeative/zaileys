---
title: "Simplified WhatsApp API for Node.js & TypeScript"
description: "Zaileys is a type-safe, batteries-included WhatsApp bot framework for Node.js and TypeScript built on Baileys — send messages, buttons, AIRich, and more."
---
