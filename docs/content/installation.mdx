---
description: "Install Zaileys with npm, pnpm, yarn, or bun. Node 20+, dual ESM/CJS, and optional storage peer deps (SQLite, Postgres, Redis, Convex) plus sharp for media."
---
