---
title: "Multiple Accounts — Running Many WhatsApp Numbers"
description: "Run several WhatsApp accounts from one Zaileys app: one Client per account, per-account storage isolation, a client registry, lifecycle management, cloud multi-number webhook routing, and ban-safety per number."
---
