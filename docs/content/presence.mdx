---
description: "Drive WhatsApp presence indicators with zaileys — mark your account online or offline, show typing and recording status in any chat, and configure the built-in throttle that prevents presence spam."
---
