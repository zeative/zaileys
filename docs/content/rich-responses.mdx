---
description: "AIRich turns plain markdown into rich WhatsApp messages in Zaileys — bold, links, tables, LaTeX, code, images, and directives like suggest, tip, and product."
---
