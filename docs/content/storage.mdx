---
description: "Persist WhatsApp sessions and chat history with Zaileys storage adapters — File, Memory, SQLite, Postgres, Redis, and Convex for auth and message stores."
---
