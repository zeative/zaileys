...
| --- | --- | --- |
| A support bot that answers common questions | [Events](/concepts/events), [Commands](/bots/commands) | Both |
| An order bot customers tap through | [Buttons & lists](/messaging/interactive) | Both |
| Daily reminders or announcements to a list | [Broadcast & schedule](/bots/broadcast-and-schedule) | Both |
