...
> Source: https://zeative.github.io/zaileys/commands
...
| `send(to?)` | `MessageBuilder` | Starts a message aimed at **this chat**. Pass a jid to send elsewhere. Shorthand for `ctx.client.send(ctx.roomId)`. |
