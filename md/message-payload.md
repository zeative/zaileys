...
| `isGroupStatusMention` | a group-status-mention message (someone mentioned this group in *their* status). |
| `isGroupStatus` | the message **is** a group status post. `chatType` still reflects the inner content (`text`, `image`, …). |
